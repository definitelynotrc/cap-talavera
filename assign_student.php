...
if (isset($_POST['assign_student'])) {
    ...
    // If the student is already assigned to the subject, show an error message
    if ($checkAssignmentResult->num_rows > 0) {
        echo "<script>alert('This student is already assigned to the selected subject.');</script>";
    } else {
