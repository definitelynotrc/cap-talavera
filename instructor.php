        ...
        <div class="Addmodal-dialog">
            <div class="Addmodal-content">
                <div class="Addmodal-header" style="display: flex; justify-content: space-between;">
                    <h5 class="Addmodal-title" id="addStudentModalLabel">Add Instructor</h5>
                    <button type="button" id="closeAddModal" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="Addmodal-body">
                    <form method="POST" action="add_instructor.php" id="addStudentForm">
                        ...
                        <button type="submit" class="btn btn-blue" name="submit">Add Instructor</button>
                    </form>
                </div>
            </div>
        </div>
